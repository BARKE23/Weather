...
import com.example.myweather.forecast.HourlyWeatherForecast;
import com.example.myweather.forecast.WeeklyWeatherForecast;
...
public class WeatherActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        editor=pref.edit();
        if(string_weather_forcast.equals("")||string_hourly_weather_forcast.equals("")){
            getData();
...
//        tv_update = findViewById(R.id.tv_update);
    ...
    void draw(){
        ...
        if(hourlyWeatherForecast == null ||weeklyWeatherForecast==null) return ;
        try{
    ...
    void getData(){
        new Thread() {
            public void run() {
                try {
                    CitySQL citySQL = new CitySQL(this);
                    Log.d("TAG", string_city);
                    String string_city1 = citySQL.ChangeInfomat(string_city).toString2();
